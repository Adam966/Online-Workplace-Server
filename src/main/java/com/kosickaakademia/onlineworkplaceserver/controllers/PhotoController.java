...
public class PhotoController {
    private static final String PHOTO_USER = "photo-user/{userId}";
    private static final String PHOTO_WORKPLACE = "photo-workplace/{workplaceId}";
    ...
    public void addUserPhoto(@RequestBody MultipartFile file, @PathVariable Long userId) throws IOException {
    ...
    public void addWorkplacePhoto(MultipartFile file, @PathVariable Long workplaceId) throws IOException {
