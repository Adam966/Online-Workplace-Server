create table checklist (id bigint not null auto_increment, name varchar(255), workplace_entity_id bigint, primary key (id)) engine=InnoDB;
...
create table note (id bigint not null auto_increment, name varchar(255), description varchar(255), due_date datetime(6), workplace_entity_id bigint, primary key (id)) engine=InnoDB;
...
create table thread (id bigint not null auto_increment, name varchar(255), description varchar(255), workplace_entity_id bigint, primary key (id)) engine=InnoDB;
...
alter table note_label add constraint FK8kho1e1j5c32c09d9pcjd9grp foreign key (label_id) references note (id);
alter table note_user add constraint FKdswq8f647nhbhsavo1x24smh6 foreign key (note_id) references user (id);
alter table note_user add constraint FKsfx7tt0oyprv2y92yc72a5hhb foreign key (user_id) references note (id);
