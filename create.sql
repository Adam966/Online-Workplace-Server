...
create table task (id bigint not null auto_increment, description varchar(255), due_date datetime(6), is_completed bit not null, primary key (id)) engine=InnoDB
