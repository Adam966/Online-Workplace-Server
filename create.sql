...
create table notification (id bigint not null auto_increment, creation_time datetime(6), description varchar(255), type integer, recipient_user_id bigint, sender_user_id bigint, workplace_entity_id bigint, primary key (id)) engine=InnoDB
